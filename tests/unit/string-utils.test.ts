/**
 * ============================================
 * TESTES UNITÁRIOS - STRING UTILS (TypeScript)
 * ============================================
 */
import {
    formatPhone,
    ...
    isValidEmail,
    isValidCPF,
} from '../../public/js/utils/string-utils';
...
describe('String Utils - slugify', () => {
    ...
    test('deve remover símbolos e caracteres especiais', () => {
...
describe('String Utils - isValidEmail', () => {
    ...
    test('deve retornar false para valor null/undefined/vazio', () => {
