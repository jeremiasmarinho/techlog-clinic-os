/**
 * ============================================
 * TESTES UNITÁRIOS - CURRENCY UTILS (TypeScript)
 * ============================================
 */
import {
    formatCurrency,
    ...
    formatPercent,
    calculateGrowth,
} from '../../public/js/utils/currency-utils';
...
describe('Currency Utils - formatCurrency', () => {
    ...
    test('deve retornar R$ 0,00 para valores inválidos', () => {
        // Para null/undefined/NaN/invalid, a função retorna string hardcoded com espaço regular
    ...
    test('deve formatar valores pequenos', () => {
