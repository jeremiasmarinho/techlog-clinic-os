...
Transformar o código monolítico de **1.568 linhas** (kanban.js) e **489 linhas** (admin.js) em uma arquitetura modular, testável e manutenível.
...
const revenue = formatCurrency(1530.50);  // "R$ 1.530,50"
...
| Ocupação | Cor | Badge |
|----------|-----|-------|
| < 50% | Verde (emerald) | Tranquila |
| 50-69% | Azul (blue) | Normal |
| 70-89% | Amarelo (amber) | Atenção |
