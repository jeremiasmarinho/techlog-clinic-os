...
export function updateStats(list) {
    ...
    document.getElementById('newPatients').textContent = stats.new;
    document.getElementById('inProgressPatients').textContent = stats.inProgress;
    document.getElementById('scheduledPatients').textContent = stats.scheduled;
}
