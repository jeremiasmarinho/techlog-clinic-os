...
function seedRealisticData() {
    ...
    leads.forEach((lead, index) => {
        stmt.run(lead.name, lead.phone, lead.status, lead.type || 'geral', lead.source || 'Manual', lead.value || 0, lead.appointment_date || null, lead.doctor || null, lead.notes || null, lead.attendance_status || null, lead.created_at || new Date().toISOString(), (err) => {
            if (err) {
...
//# sourceMappingURL=force_seed.js.map