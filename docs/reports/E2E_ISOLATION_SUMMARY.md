...
**Antes**: Testes E2E modificavam o banco de dados de produção (`clinic.db`), causando perda de
dados reais.

**Depois**: Testes E2E usam banco de dados isolado (`clinic.test.db`), mantendo dados de produção
seguros.
