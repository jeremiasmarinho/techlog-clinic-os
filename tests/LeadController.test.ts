...
describe('LeadController', () => {
    ...
    describe('POST /api/leads - Create Lead', () => {
        ...
        it('should fail when name is missing', async () => {
            ...
            const response = await request(app).post('/api/leads').send(invalidLead).expect(400);
    ...
    describe('DELETE /api/leads/:id - Delete Lead', () => {
        ...
        it('should require authentication', async () => {
            const response = await request(app).delete(`/api/leads/${testLeadId}`).expect(401);
    ...
    describe('GET /api/leads/dashboard - Metrics', () => {
        it('should require authentication', async () => {
            const response = await request(app).get('/api/leads/dashboard').expect(401);
    ...
    describe('PUT /api/leads/:id/archive - Archive Lead', () => {
        ...
        it('should require authentication', async () => {
            const response = await request(app).put(`/api/leads/${testLeadId}/archive`).expect(401);
