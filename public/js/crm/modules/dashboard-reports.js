...
export function generateWeeklyReport(history, byAttendanceStatus) {
...
export function generateStatusReport(byStatus, total) {
    const statusMap = {
        'novo': '🟢 Novos',
...
export function generateTypesReport(byType, byAttendanceStatus) {
    ...
    const rescheduled = byAttendanceStatus?.find(a => a.attendance_status === 'remarcado')?.count || 0;
...
export function copyReportText(elementId) {
