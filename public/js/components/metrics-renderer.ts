...
interface MetricsData {
    ...
    tomorrowConfirmations: ConfirmationsData;
    todayOccupancy: OccupancyData;
 ...
 */
export function renderMetrics(metrics: MetricsData): void {
    if (!metrics) return;
 ...
 */
function renderDailyRevenue(revenue: RevenueData, growth: GrowthData): void {
 ...
 */
function renderTomorrowConfirmations(confirmations: ConfirmationsData): void {
    const countEl = document.getElementById('tomorrowCount');
    const confirmEl = document.getElementById('tomorrowConfirm');

    if (countEl) {
        countEl.textContent = String(confirmations.count);
 ...
 */
function renderTodayOccupancy(occupancy: OccupancyData): void {
    ...
    if (appointmentsEl) {
        appointmentsEl.textContent = String(occupancy.count);
 ...
 */
function renderAverageTicket(ticket: TicketData): void {
 ...
 */
function getOccupancyBadgeColor(percent: number): string {
...
export function clearMetrics(): void {
    const elements: ClearMetricElement[] = [
